#!/usr/bin/env python3
"""
Test V4 Phase 6 ONLY: Component Classification for MetaFFI
"""
...
async def test_phase6_only_metaffi():
    """Test Phase 6 ONLY: Component Classification for MetaFFI."""
    print("INFO:test_phase6_only_metaffi:Running Phase 6 ONLY: Component Classification...")
    ...
    print(f"INFO:test_phase6_only_metaffi:Using repository: {test_repo_path}")
    
    # Load Phase 1-5 results from previous tests
    phase1_results = {
        "repository_overview": {
            "name": "MetaFFI",
            "type": "library",
    ...
    try:
        ...
        print(f"INFO:test_phase6_only_metaffi:Phase 6 completed in {execution_time:.1f} seconds")
        ...
        print(f"INFO:test_phase6_only_metaffi:Components classified: {len(components)}")
        print(f"INFO:test_phase6_only_metaffi:Classifications made: {len(classifications)}")
        
        print("[OK] Phase 6 ONLY test with MetaFFI passed")
        return True
        
    except Exception as e:
        print(f"ERROR:test_phase6_only_metaffi:Phase 6 failed: {e}")
        import traceback
        print(f"Traceback: {traceback.format_exc()}")
        return False

if __name__ == "__main__":
    success = asyncio.run(test_phase6_only_metaffi())
    if not success:
        sys.exit(1)
