#!/usr/bin/env python3
"""
Test V7 Phase 2: Build System Detection on jni_hello_world repository (Standalone)
...
- Tests multi-language repository (C++ and Java)
"""
...
async def test_phase2_build_system_detection():
    """Test Phase 2: Build System Detection on jni_hello_world"""
    
    print("=" * 80)
    print("V7 Phase 2: Build System Detection Test")
    print("Repository: jni_hello_world")
...
{{
  ...
  "architecture_classification": {{
    "primary_language": "C++",
    "detected_languages": ["C++", "Java"],
    "language_percentages": {{"C++": 60.0, "Java": 40.0}},
    "multi_language": true,
    "repository_type": "application",
    "notes": "Multi-language C++/Java JNI application"
  }},
...
{{
  ...
  "build_analysis": {{
    ...
    "language_build_mapping": {{"C++": "cmake", "Java": "cmake"}}
  }},
  "confidence_verification": {{
...
"""
    ...
    if "Java" in language_mapping and language_mapping["Java"] == "cmake":
        print("✅ Java to CMake mapping correctly established")
    else:
        print("❌ Java to CMake mapping NOT established")
    ...
    success = (
        ...
        language_mapping["C++"] == "cmake" and
        "Java" in language_mapping and 
        language_mapping["Java"] == "cmake"
    )
    ...
    # Save results
    results = {
        "test": "V7 Phase 2: Build System Detection (JNI Standalone)",
    ...
    results_file = project_root / "tests" / "llm0" / "v7" / "phase2_jni_test_results.json"
