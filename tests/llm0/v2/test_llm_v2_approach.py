#!/usr/bin/env python3
"""
Test the LLM RIG Generator V2 with directory listing + context tracking approach.
"""
...
def test_llm_v2_approach():
    ...
    print("=" * 60)
    print("LLM RIG GENERATOR V2 TEST")
    print("=" * 60)
    ...
    try:
        ...
        generator.max_requests_per_phase = 20  # Reasonable limit
        
        print("INIT: Initializing LLM RIG Generator V2...")
        
        # Test complete RIG generation with V2 approach
        print("RUNNING: Complete RIG Generation (V2)...")
...
if __name__ == "__main__":
    import json
    success = test_llm_v2_approach()
    if success:
        print("\n" + "=" * 60)
        print("SUCCESS: LLM V2 approach test PASSED!")
        print("=" * 60)
    else:
        print("\n" + "=" * 60)
        print("ERROR: LLM V2 approach test FAILED!")
        print("=" * 60)
        sys.exit(1)
