#!/usr/bin/env python3
"""
Phase-by-phase LLM test to avoid the "reading all files" problem.
"""
...
def test_phase_by_phase():
    """Test LLM functionality phase by phase with strict limits."""
    print("=" * 60)
    print("PHASE-BY-PHASE LLM TEST")
    print("=" * 60)
    ...
    try:
        ...
        generator.max_requests_per_phase = 15  # Strict limit per phase
...
if __name__ == "__main__":
    success = test_phase_by_phase()
    if success:
        print("\n" + "=" * 60)
        print("SUCCESS: Phase-by-phase LLM test PASSED!")
        print("=" * 60)
    else:
        print("\n" + "=" * 60)
        print("ERROR: Phase-by-phase LLM test FAILED!")
        print("=" * 60)
        sys.exit(1)
